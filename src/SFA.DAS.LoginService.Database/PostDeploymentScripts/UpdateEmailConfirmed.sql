...
BEGIN TRY
    ...
    -- automatically confirm the email of those users which do not have a confirm request; as these are the existing invited
	-- users which required the one off update to their email confirmed status
	UPDATE 

...
{
    public class When_CheckExistsConfirmEmail_called_for_expired_request : CheckExistsConfirmEmailTestBase
    {
        [SetUp]
        ...
        [Test]
        public async Task Then_result_IsValid_should_be_false_And_result_HasRequest_should_be_true()
        {

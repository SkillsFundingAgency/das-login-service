BEGIN TRANSACTION
	...
	DECLARE @samplesmvclocalclientnetcorenetframework INT
    ...
    VALUES
           (1 --<Enabled, bit,>
           ,'samples.mvclocalclient.netframework' --<ClientId, nvarchar(200),>
           ,'oidc' --<ProtocolType, nvarchar(200),>
           ,0 --<RequireClientSecret, bit,>
           ,'Example Implicit Client Application .Net Framework' --<ClientName, nvarchar(200),>
	...
	SELECT @samplesmvclocalclientnetcorenetframework = SCOPE_IDENTITY()
	...
	INSERT INTO [IdentityServer].[ClientPostLogoutRedirectUris]
           ...
           ,[ClientId])
     VALUES
           ('https://localhost:44353/' --<PostLogoutRedirectUri, nvarchar(2000),>
           ,@samplesmvclocalclientnetcorenetframework --<ClientId, int,>
		   )
	...
	INSERT INTO [IdentityServer].[ClientRedirectUris]
           ...
           ,[ClientId])
	VALUES
           ('https://localhost:44353/signin-oidc' --<RedirectUri, nvarchar(2000),>
           ,@samplesmvclocalclientnetcorenetframework --<ClientId, int,>
		   )
	...
	INSERT INTO [LoginService].[Clients]
           ...
           ,[AllowLocalSignUp])
	VALUES
           ('7C2D22B5-16B5-4369-B7B3-0FF6C3957646' --<Id, uniqueidentifier,>
		   ,N'{"ServiceName":"Sample Mvc Local Client .Net Framework Service","ServiceTeam":"Sample Mvc Local Client .Net Framework Service Team","CreateAccountPurpose":"to demonstrate local sign-up","SupportUrl":"https://acme.com/support","PostPasswordResetReturnUrl":"https://localhost:44353/","EmailTemplates":[{"Name":"SignUpInvitation","TemplateId":"a2fc2212-253e-47c1-b847-27c10f83f7f5"},{"Name":"PasswordReset","TemplateId":"ecbff8b8-3ad4-48b8-a42c-7d3f602dbbd3"},{"Name":"PasswordResetNoAccount","TemplateId":"04326941-2067-4956-8dc2-4ccd60c84af5"},{"Name":"LoginPasswordWasReset", "TemplateId":"fa156448-44d5-4d76-8407-685a609a14ca"},{"Name":"ConfirmEmail", "TemplateId":"e1786517-84de-4583-9bc3-a41ce9769ea3"}]}'  --<ServiceDetails, nvarchar(max),>
           ,'samples.mvclocalclient.netframework' --<IdentityServerClientId, nvarchar(250),>

...
namespace SFA.DAS.LoginService.Application.UnitTests.ConfirmEmail.VerifyConfirmEmail
{
    [TestFixture]
    public class VerifyConfirmEmailTestBase
    {
        protected VerifyConfirmEmailHandler Handler;
        ...
        public void SetUp()
        {
            ...
            Handler = new VerifyConfirmEmailHandler(LoginContext, UserService);

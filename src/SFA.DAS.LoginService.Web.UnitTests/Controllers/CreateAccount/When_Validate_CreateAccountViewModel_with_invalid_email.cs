...
{
    [TestFixture]
    public class When_Validate_CreateAccountViewModel_with_invalid_email
    {
        ...
        [Test]
        public void Then_Validation_Result_contains_Email_invalid_error()
        {
            _viewModel.GivenName = "Brian";
            _viewModel.FamilyName = "Smith";
            _viewModel.Username = "invalidemailaddress";
            ...
            _results[0].ErrorMessage.Should().Be("Enter a valid email address");

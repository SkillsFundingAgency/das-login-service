...
{
    [TestFixture]
    public class When_Validate_CreateAccountViewModel_with_non_matching_passwords
    {
        ...
        public void Then_Validation_Result_contains_ConfirmPassword_non_matching_error()
        {
            ...
            _viewModel.ConfirmPassword = "AValidPassw0rd2";
            ...
            //_results[0].MemberNames.Should().OnlyContain(p => p == nameof(CreateAccountViewModel.ConfirmPassword));
        }
    }
}
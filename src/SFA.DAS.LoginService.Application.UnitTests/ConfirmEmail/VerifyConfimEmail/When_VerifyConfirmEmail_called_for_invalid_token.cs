...
{
    public class When_VerifyConfirmEmail_called_for_invalid_token : VerifyConfirmEmailTestBase
    {
        ...
        public async Task Arrange()
        {
            ...
            LoginContext.ConfirmEmailRequests.Add(new ConfirmEmailRequest() { Id = currentRequestIds[1], Email = "email+two@emailaddress.com", ValidUntil = SystemTime.UtcNow().AddMinutes(20), IsComplete = true, IdentityToken = "DEF/" + _identityToken });
        ...
        public async Task Then_the_correct_response_is_returned()
        {
            ...
            response.VerifyConfirmedEmailResult.Should().Be(VerifyConfirmedEmailResult.TokenInvalid);
        }
    }
}
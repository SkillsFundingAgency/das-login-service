...
{
    public class When_BuildLoginViewModel_called_for_client_with_allowLocalSignIn_false_and_CreateAccountLink_not_supplied : BuildLoginViewModelTestBase
    {
        private string _supportUrl = "https://acme.gov.uk/Support";
        private string _createAccountUrl = string.Empty;
        ...
        public async Task Arrange()
        {
            LoginContext.Clients.Add(new Data.Entities.Client()
            {
                ...
                ServiceDetails  = new ServiceDetails{ServiceName = "Acme Service", SupportUrl = _supportUrl, CreateAccountUrl = _createAccountUrl},
                Id = ClientId,
        ...
        public async Task Then_LoginViewModel_contains_correct_CreateAccount_details()
        {
            ...
            result.CreateAccountDetails.CreateAccountUrl.Should().Be(null);

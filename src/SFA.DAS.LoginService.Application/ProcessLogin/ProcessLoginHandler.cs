    ...
    public async Task<ProcessLoginResponse> Handle(ProcessLoginRequest request, CancellationToken cancellationToken)
    {
      ...
      if (!signInResult.Succeeded)
      {
        ...
        return signInResult.IsLockedOut
            ...
            : new ProcessLoginResponse() { Message = "Make sure you've entered the correct email address and password. If you've forgotten your password you can reset it by selecting 'I have forgotten my password' below." };
      }

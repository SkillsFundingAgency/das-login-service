...
{
    public class When_VerifyConfirmEmail_called_for_expired_token : VerifyConfirmEmailTestBase
    {
        ...
        public async Task Then_the_correct_response_is_returned()
        {
            ...
            response.VerifyConfirmedEmailResult.Should().Be(VerifyConfirmedEmailResult.TokenExpired);
        }
    }
}